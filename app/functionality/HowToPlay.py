...
class HowtoPlay(QWidget):
    ...
    def __init__(self):
        ...
        self.title_font = QFont("Consolas", 30, QFont.Bold)
        ...
        roles_button.clicked.connect(self.mostrarRoles.emit)
        ...
        back_button.clicked.connect(self.mostrarMenuPrincipal.emit)
